      ...
      <div className="max-h-[80vh] overflow-y-auto">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 pt-2 border-t border-gray-100 mt-2">
            ...
            <button
              type="submit"
              disabled={loadingHours || loadingTables}
              className="bg-[#0D784A] hover:bg-[#0B6A41] text-white font-medium rounded-lg px-4 py-2 transition w-full sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
            >
