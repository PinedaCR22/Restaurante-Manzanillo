...
import { TourismActivityForm } from "./TourismActivityForm";
...
export function TourismActivityList({ onSelect }: Props) {
  const [activities, setActivities] = useState<TourismActivity[]>([]);
  const [showForm, setShowForm] = useState(false);
  const [selected, setSelected] = useState<TourismActivity | null>(null);
